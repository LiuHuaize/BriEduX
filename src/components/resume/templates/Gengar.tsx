...
const Header = () => {
  ...
  return (
    <div className="p-8 space-y-4 bg-primary text-background">
      {basics.picture.url && !basics.picture.effects.hidden && (
        <img
          ...
          className={cn(
            ...
            basics.picture.effects.border && 'border-background',
...
const Summary = () => {
  ...
  return (
    <section id="summary">
      <h2 className="mb-2 text-lg font-bold text-primary">{summary.name}</h2>
      <div
...
const Experience = () => {
  ...
  return (
    <section id="experience">
      <h2 className="mb-4 text-lg font-bold text-primary">{experience.name}</h2>
...
const Education = () => {
  ...
  return (
    <section id="education">
      <h2 className="mb-4 text-lg font-bold text-primary">{education.name}</h2>
      <div className="space-y-4">
...
const Skills = () => {
  ...
  return (
    <section id="skills">
      <h2 className="mb-4 text-lg font-bold text-primary">{skills.name}</h2>
      <div className="space-y-4">
...
export const GengarTemplate = ({ isFirstPage, columns }: GengarTemplateProps) => {
  return (
