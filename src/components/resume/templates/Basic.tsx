...
const Experience = () => {
  ...
  return (
    <section id="experience">
      <h2 className="mb-2 text-lg font-bold">{experience.name}</h2>
...
const Education = () => {
  ...
  return (
    <section id="education">
      <h2 className="mb-2 text-lg font-bold">{education.name}</h2>
      <div className="space-y-4">
...
const Skills = () => {
  ...
  return (
    <section id="skills">
      <h2 className="mb-2 text-lg font-bold">{skills.name}</h2>
      <div className="space-y-4">
...
export const BasicTemplate = ({ isFirstPage, columns }: BasicTemplateProps) => {
  return (
