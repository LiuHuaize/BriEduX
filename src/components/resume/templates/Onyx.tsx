...
const Experience = () => {
  ...
  return (
    <section id="experience">
      <h2 className="mb-4 text-lg font-bold border-b border-primary pb-1">{experience.name}</h2>
...
const Education = () => {
  ...
  return (
    <section id="education">
      <h2 className="mb-4 text-lg font-bold border-b border-primary pb-1">{education.name}</h2>
      <div className="space-y-4">
...
const Skills = () => {
  ...
  return (
    <section id="skills">
      <h2 className="mb-4 text-lg font-bold border-b border-primary pb-1">{skills.name}</h2>
      <div className="space-y-4">
...
export const OnyxTemplate = ({ isFirstPage, columns }: OnyxTemplateProps) => {
  return (
